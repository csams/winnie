...
var $author$project$Sections$renderBanner = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('winnie-banner')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('container text-center text-white')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Gwendolyn \"Winnie\" Joyce Sams')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Coming September 12, 2020')
						]))
				]))
		]));
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Copyright © Christopher, Jo Ellen, and Winnie Sams 2020')
						]))
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('nav-link js-scroll-trigger'),
						$elm$html$Html$Attributes$href(
						A2($elm$core$String$append, '#', identifier))
					]),
				_List_fromArray(
					[name]))
			]));
...
var $author$project$Sections$renderNavigation = function (picGroups) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('navbar navbar-expand-lg navbar-dark bg-dark fixed-top'),
				$elm$html$Html$Attributes$id('mainNav')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('navbar-brand js-scroll-trigger'),
								$elm$html$Html$Attributes$href('#page-top')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Winnie Sams')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$attribute, 'aria-controls', 'navbarResponsive'),
								...
								A2($elm$html$Html$Attributes$attribute, 'data-target', '#navbarResponsive'),
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$id('navbarResponsive')
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$Sections$renderPicture = function (pic) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('col-md-6 col-lg-4')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('card border-0 transform-on-hover')
					]),
				_List_fromArray(
					[
						A2(
